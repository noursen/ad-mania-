...
$listeE = $evenementC->afficherEventProchain();
...
<body>
    <link rel="stylesheet" href="style230.css" />
    <section>
    <div class="navigation">
      <ul>
        <li><a href="#" class="active"><span>Evénement</span></a></li>
        <li><a href="ProchainEvent.php"><span>Upcoming events</span></a></li>
        <li><a href="index2.php"><span>Today's events</span></a></li>
